...
public final class Redimensionar_JTabela implements PropertyChangeListener, TableModelListener {
     ...
     */
    public Redimensionar_JTabela(JTable table) {
        this(table, 6);
    }
     ...
     */
    public Redimensionar_JTabela(JTable table, int spacing) {
        this.table = table;
