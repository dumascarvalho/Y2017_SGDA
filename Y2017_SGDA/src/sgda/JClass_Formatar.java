...
public class JClass_Formatar {
    
    public void formataçãoData(JFormattedTextField campo, java.awt.event.KeyEvent evento) {        
    ...
    public void filtrarSpinner(JSpinner campo) {
