...
public final class JClass_JTable implements PropertyChangeListener, TableModelListener {
     ...
     */
    public JClass_JTable(JTable table) {
        this(table, 6);
    }
     ...
     */
    public JClass_JTable(JTable table, int spacing) {
        this.table = table;
...
//
    ...
    /*
	 *  Toggle properties of the JClass_JTable so the user can
