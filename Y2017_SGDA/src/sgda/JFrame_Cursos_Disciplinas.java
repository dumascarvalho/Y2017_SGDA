...
public class JFrame_Cursos_Disciplinas extends javax.swing.JFrame {

    public JFrame_Cursos_Disciplinas() {
        initComponents();
        atualizarDados(cmbCódigoCurso, cmbNomeCurso, "id_curso", "descricao", "SELECT * FROM curso");
    ...
    private void initComponents() {
        ...
        setTitle("Relação de Cursos e Disciplinas");
        setResizable(false);
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(cmbNomeCurso, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btnInserirDadosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInserirDadosActionPerformed
        inserirDados(cmbCódigoCurso, cmbCódigoDisciplina, "curso_disciplina");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            new JFrame_Cursos_Disciplinas().setVisible(true);
        });
    }
